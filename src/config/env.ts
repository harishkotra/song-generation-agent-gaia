...
export const GAIA_API_KEY = process.env.GAIA_API_KEY!;
export const GAIA_NODE_URL = process.env.GAIA_NODE_URL!;
export const GAIA_MODEL_NAME = process.env.GAIA_MODEL_NAME!;